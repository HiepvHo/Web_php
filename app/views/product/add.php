...
<body>
    <div class="container">
        ...
        <div class="page-header fade-in">
            ...
            <p class="text-muted">Thêm sản phẩm mới vào hệ thống</p>
        </div>
        ...
        <div class="card slide-in">
            <div class="card-body">
                ...
                <form action="/project1/Product/add" method="POST" enctype="multipart/form-data" id="productForm">
                    <!-- Image Upload Section -->
                    <div class="text-center mb-4 fade-in">
                        <div class="image-upload" id="imageUploadContainer">
                            <img id="imagePreview" src="/project1/public/images/default-product.jpg" 
                                 class="image-preview mb-2" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <textarea class="form-control" id="description" name="description" 
                                      rows="4" required placeholder="Nhập mô tả sản phẩm"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                        </div>
                    </div>
